        ...
        <div class="container">    
            ...
            <div class="row justify-content-center">
                <div class="col-md-12 heading-section ftco-animate">
                    <h4 class="mb-4 title-page text-center" id="title-page">ESQUECI MINHA SENHA</h4>
                    <div class="row">
                        <div class="col-md-8" style="padding-left: 60px;">
                            <h5>ALTERAÇÃO DE SENHA</h5>
                            <p>Informe seu e-mail de cadastro para receber ume e-mail com as instruções para realizar a criação de uma nova senha.</p>
