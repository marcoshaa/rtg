        ...
        <tr>
            ...
            <td nowrap>    
                <div class="text-right">						
                    <button type="button" data-action="<?= site_url("request/viewticket/{$item['id']}") ?>" class="btn btn-primary btn-xs btn-visualizar-pedido btn-rounded" role="button" title="Excluir Valor">
